...
//         const elementBtn = element.querySelector(".button");
...
document.addEventListener('DOMContentLoaded', function () {
    var grid = document.querySelector('.grid');
    if (!grid) {
        console.error("Error: Element with class 'grid' not found.");
    ...
    if (!tabsUl) {
        // console.error("Error: Element with id 'filter-tab-group' not found.");
        return; // Exit if the tabsUl is not found
    }
